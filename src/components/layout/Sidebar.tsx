...
type NavKey = 'dashboard' | 'gateway' | 'agents' | 'channels' | 'tools' | 'skills' | 'cron' | 'chat' | 'rawConfig' | 'usage' | 'sessions' | 'instances' | 'security' | 'install' | 'localModels';
          ...
          <div key={group.groupKey} style={{ marginBottom: gi < navGroups.length - 1 ? 6 : 0 }}>
            ...
            {group.items.map(item => {
              ...
              const label = item.labelKey === 'usage' ? t.usage.title :
                            ...
                            item.labelKey === 'install' ? t.nav.install :
                            item.labelKey === 'localModels' ? t.nav.localModels :
