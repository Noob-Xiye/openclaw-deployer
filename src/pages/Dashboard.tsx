      ...
      {loadError && (
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <strong>{t.loadError}:</strong> {loadError}
          </div>
          <p style={{ margin: '8px 0 0 24px', fontSize: 11, opacity: 0.8 }}>
            Config path: {configPath || t.configPathHint}
          </p>
        </div>
      )}
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 12 }}>
            <StatCard
              ...
              value={gatewayPort}
              sub={t.dashboard.gatewayPortSub}
            ...
            <StatCard
              ...
              sub={t.dashboard.totalChannels.replace('{count}', String(totalChannels))}
            ...
            <StatCard
              ...
              value={agentCount || 1}
              sub={agentCount === 0 ? t.dashboard.defaultAgent : t.dashboard.configuredAgentsCount.replace('{count}', String(agentCount))}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            ...
            <SectionCard title={t.dashboard.configSummary}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                {[
                  { label: t.dashboard.primaryModel, value: primaryModel || '—', mono: true },
                  { label: t.dashboard.gatewayPortLabel, value: String(gatewayPort), mono: true },
                  { label: t.dashboard.reloadMode, value: config.gateway?.reload?.mode || 'hybrid' },
                  { label: t.dashboard.toolProfile, value: config.tools?.profile || 'full' },
                  { label: t.dashboard.heartbeat, value: heartbeatEnabled ? (config.agents?.defaults?.heartbeat?.every || 'on') : 'off' },
                  { label: t.dashboard.sessionScope, value: config.session?.dmScope || 'main' },
                ].map(row => (
            ...
            <SectionCard title={t.dashboard.quickActions}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <QuickLink
                  label={t.quickActions.gateway} desc={t.quickActions.gatewayDesc}
                ...
                />
                <QuickLink
                  label={t.quickActions.agents} desc={t.quickActions.agentsDesc}
                ...
                />
                <QuickLink
                  label={t.quickActions.channels} desc={t.quickActions.channelsDesc}
                ...
                />
                <QuickLink
                  label={t.quickActions.rawConfig} desc={t.quickActions.rawConfigDesc}
          ...
          <SectionCard>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <Badge variant="success">{t.loaded}</Badge>
            </div>
          </SectionCard>
        </>
      )}
